...
urlpatterns: list[URLPattern | URLResolver] = [
    ...
    path("equipment-one/<int:equipment_id>/", equipment_one, name="equipment_one"),
    path("equipment/<int:equipment_id>/destroy/", equipment_destroy, name="equipment_destroy"),
    path("equipment/<int:equipment_id>/recipes/", equipment_recipes, name="equipment_recipes"),
    path("equipment/<int:equipment_id>/update/", equipment_update, name="equipment_update"),
    path("equipment/create/", equipment_create, name="equipment_create"),
    path("food-many/", food_many, name="food_many"),
    path("food-one/<int:food_id>/", food_one, name="food_one"),
    path("food/<int:food_id>/destroy/", food_destroy, name="food_destroy"),
    path("food/<int:food_id>/recipes/", food_recipes, name="food_recipes"),
    path("food/<int:food_id>/update/", food_update, name="food_update"),
    path("food/create/", food_create, name="food_create"),
    path("ingredient/<int:ingredient_id>/", ingredient, name="ingredient"),
    ...
    path("rating/<int:recipe_id>/", rating, name="rating"),
    path("rating/<int:recipe_id>/update/", rating_update, name="rating_update"),
    path("recipe/<int:recipe_id>/", recipe, name="recipe"),
    path("recipe/<int:recipe_id>/destroy/", recipe_destroy, name="recipe_destroy"),
    path("recipe/<int:recipe_id>/direction/create/", direction_create, name="direction_create"),
    path("recipe/<int:recipe_id>/equipment/<int:equipment_id>/unlink/", equipment_unlink, name="equipment_unlink"),
    path("recipe/<int:recipe_id>/equipment/link/", equipment_link, name="equipment_link"),
    path("recipe/<int:recipe_id>/ingredient/create/", ingredient_create, name="ingredient_create"),
    path("recipe/<int:recipe_id>/notes/destroy/", notes_destroy, name="notes_destroy"),
    path("recipe/<int:recipe_id>/notes/update/", notes_update, name="notes_update"),
    path("recipe/<int:recipe_id>/rating/destroy/", rating_destroy, name="rating_destroy"),
    path("recipe/<int:recipe_id>/servings/destroy/", servings_destroy, name="servings_destroy"),
    path("recipe/<int:recipe_id>/servings/update/", servings_update, name="servings_update"),
    path("recipe/<int:recipe_id>/tag/<int:tag_id>/unlink/", tag_unlink, name="tag_unlink"),
    path("recipe/<int:recipe_id>/tag/link/", tag_link, name="tag_link"),
    path("recipe/<int:recipe_id>/time/<int:time_id>/", time, name="time"),
    path("recipe/<int:recipe_id>/time/<int:time_id>/update/", time_update, name="time_update"),
    path("recipe/<int:recipe_id>/time/create/", time_create, name="time_create"),
    path("recipe/<int:recipe_id>/title/update/", recipe_title_update, name="recipe_title_update"),
    ...
    path("time-category/<int:time_category_id>/destroy/", time_category_destroy, name="time_category_destroy"),
    path("time-category/<int:time_category_id>/recipes/", time_category_recipes, name="time_category_recipes"),
    path("time-category/<int:time_category_id>/update/", time_category_update, name="time_category_update"),
    path("time-category/create/", time_category_create, name="time_category_create"),
    path("time/<int:time_id>/destroy/", time_destroy, name="time_destroy"),
    path("unit/<int:unit_id>/", unit),
    path("unit/<int:unit_id>/destroy/", unit_destroy, name="unit_destroy"),
    path("unit/<int:unit_id>/recipes/", unit_recipes, name="unit_recipes"),
    path("unit/<int:unit_id>/update/", unit_update, name="unit_update"),
