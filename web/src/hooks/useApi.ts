...
export default function useApi() {
  ...
  return {
    ...
    brandRecipesGet: withSendAndArgs(brandRecipesGet),
    brandsGet: withSendAndOptionalArgs(brandsGet),
    brandUpdate: withSendAndArgs(brandUpdate),
    directionCreate: withSendAndArgs(directionCreate),
    directionDestroy: withSendAndArgs(directionDestroy),
    directionGet: withSendAndArgs(directionGet),
    directionsReorder: withSendAndArgs(directionsReorder),
    directionUpdate: withSendAndArgs(directionUpdate),
    ...
    foodDestroy: withSendAndArgs(foodDestroy),
    foodManyGet: withSendAndOptionalArgs(foodManyGet),
    foodOneGet: withSendAndArgs(foodOneGet),
    foodRecipesGet: withSendAndArgs(foodRecipesGet),
    foodUpdate: withSendAndArgs(foodUpdate),
    ...
    ingredientsReorder: withSendAndArgs(ingredientsReorder),
    ...
    timeCategoryDestroy: withSendAndArgs(timeCategoryDestroy),
    timeCategoryGet: withSendAndArgs(timeCategoryGet),
    timeCategoryRecipesGet: withSendAndArgs(timeCategoryRecipesGet),
    timeCategoryUpdate: withSendAndArgs(timeCategoryUpdate),
